                ...
                <div className="containerBody">
                    ...
                    <div className="formBody">
                        <form action="" className='form'>
                            ...
                            <input type="password" id='password'  className='BodyFormInput' ref={password} minLength={8} required/>
                        ...
                        {/* {
                            error && (
                                ...
                                <span className='warningText'>{error}.</span>
                                </div>
                            )
                        } */}
...
export default EForceAdminLogin