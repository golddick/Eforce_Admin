     ...
     {TableBody.map((row) => (
      ...
      <div className="vehicleOwner">
        ...
        <div className="vODetails">
            ...
            <div className="ownerCarInfo">
              <span className='v_info'><b>Vehicle Make: </b>Lexus </span><b>.</b>
              <span className='v_info'><b>Vehicle Model: </b>Gx 470 </span><b>.</b>
      ...
      {TableBody.map((row) => (
        <tr key={row.id} className='VVDTableBody'>
          ...
          <td className='vBodyText'><div className="TextContainer">
          {row.dueDate}
          <span className='expiredStatus'>{row.dueDateStatus}</span>
            </div></td>
