  ...
  return (
    <div className='Home-Nav'>
        ...
        <div className="NavBody" ref={navBodyRef}>
           ...
           <NavLink to='/Officer-Report' className={activeButton === 'Officer-Report' ? 'activeBTN' : 'nav'} onClick={() => handleButtonClick('Officer-Report')}>Officer Reports </NavLink>
         <NavLink to='/Financial-Report' className={activeButton === 'Financial-Report' ? 'activeBTN' : 'nav'} onClick={() => handleButtonClick('Financial-Report')}> Financial Reports </NavLink>
        </div>
    </div>
  )
}
